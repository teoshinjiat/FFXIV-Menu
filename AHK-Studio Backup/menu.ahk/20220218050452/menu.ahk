...
Gui, Add, DropDownList, vColorChoice gOnChange, Black|White|Red|Green|Blue
GuiControlGet, ColorChoice 
if(ColorChoice="Black"){
	DebugWindow("if()",0,1,200,0)
...
OnChange:
DebugWindow("onChange()",0,1,200,0)
Gui, Add, DropDownList, vColorChoice1 gOnChange, Black|White|Red|Green|Blue

...
global menuData := []
menuData[ 1 ] := {function:"gAutoSynthesis", value:"vMainScript1", label:"Auto Synthesis", subOptionGuiType:"Checkbox", subOptionGuiWidth:"x60", subOptions:[{value:"Disabled vMainScript1_SubCheckBox1", label:"Auto refresh food"}, {value:"Disabled vMainScript1_SubCheckBox2", label:"Auto refresh medicine"}, {value:"Disabled vMainScript1_SubCheckBox3", label:"Collectable"}]}
...
menuData[ 5 ] := {function:"gEulmore", value:"vMainScript5", label:"Auto Eulmore Turnin", subOptionGuiType:"ListBox", subOptionGuiWidth:"x200", subOptions:[{value:"Disabled vMainScript5_SubCheckBox1", label:"Craftsman's Command Materia X"}]}
...
for i, obj in menuData{ ;mainBox mainscript boxes
	...
	for key, field in menuData[i].subOptions{ ;subBox options(parameters)
		...
		subOptionGuiWidth:=menuData[i].subOptionGuiWidth
		
		Gui, Add, %subOptionGuiType%, %subOptionGuiWidth% %value%, %label%

...
menuData[ 5 ] := {function:"gEulmore", value:"vMainScript5", label:"Auto Eulmore Turnin", subOptionGuiType:"ListBox", subOptionGuiStyle:"w350", subOptions:[{value:"Disabled vMainScript5_SubItem1", label:"Craftsman's Command Materia X"}]}
...
if(checkedBoxIndex="1") {
	...
	Run "C:\Users\teosh\Desktop\ahk\eulmoreTurnin\eulmoreTurnin.ahk" %selectedItem%

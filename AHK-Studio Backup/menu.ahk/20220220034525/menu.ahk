...
menuData[ 5 ] := {function:"gEulmore", value:"vMainScript5", label:"Auto Eulmore Turnin", subOptions:[{value:"Disabled vMainScript5_SubCheckBox1", label:"Craftsman's Command Materia X"}]}

menuData[ 1 ] := {category:"crafters_scrip_materia", subCategory:"purple_scrip_exchange_materia", item:"craftmans_command_materia_x"}
...
if(checkedBoxIndex="1") {
	...
	Run "C:\Users\teosh\Desktop\ahk\eulmoreTurnin\eulmoreTurnin.ahk"

...
if(Script="AutoSynthesis"){
	DebugWindow("matched..." Script,0,1,200,0)
}

ifequal Script,"AutoSynthesis", DebugWindow("matched..." Script,0,1,200,0)


ifequal Script,"AutoSynthesis", Run "C:\Users\teosh\Desktop\ahk\autoSynthesis\autoSynthesis.ahk"
ExitApp

...
menuData[ 5 ] := {function:"gEulmore", value:"vMainScript5", label:"Auto Eulmore Turnin", subOptionGuiType:"ListBox", subOptionGuiStyle:"w200", subOptions:[{value:"Disabled vMainScript5_SubCheckBox1", label:"Craftsman's Command Materia X"}]}

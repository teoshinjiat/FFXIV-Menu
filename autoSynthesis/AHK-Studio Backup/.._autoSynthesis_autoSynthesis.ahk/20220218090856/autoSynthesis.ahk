...
DebugWindow("parameter1 flag:"%1%,0,1,200,0)
DebugWindow("parameter2 flag:"%2%,0,1,200,0)
DebugWindow("parameter3 flag:"%3%,0,1,200,0)
...
searchDurability(filename){
	DebugWindow("filename:"filename,0,1,200,0)

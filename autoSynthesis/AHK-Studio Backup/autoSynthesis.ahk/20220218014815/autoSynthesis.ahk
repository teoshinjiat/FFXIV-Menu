...
Gui, Add, Checkbox, vMedicine, Auto refresh medicine (numpad8) when it's less than 10 minutes
...
GuiControlGet, FoodRefresh
GuiControlGet, Collectable
BtnFunc := Func("Submit").Bind(HCB, HDDL)

GuiControl, +g, %HBTN%, %BtnFunc%
MsgBox "FoodFlag" %FoodFlag%, %BtnFunc%

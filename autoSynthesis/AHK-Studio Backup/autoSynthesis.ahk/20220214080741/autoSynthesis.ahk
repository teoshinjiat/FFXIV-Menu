...
preHealthCheck(){
	...
	if(ErrorLevel=0){
		buttonToPress:=3
		DebugWindow("need to extract spiritbond buttonToPress:" + buttonToPress,0,1,2000,0)
	}
	
	imageSearch, x, y, 0, 0, 569, 133, *30, *TransBlack, durability_yellow.png
	if(ErrorLevel=0){
		buttonToPress:=4
		DebugWindow("need to repair buttonToPress:" + buttonToPress,0,1,2000,0)
	}
	
	imageSearch, x, y, 1681, 23, 2024, 125, *30, *TransBlack, food.png
	if(ErrorLevel=!0){
		buttonToPress:=f
		DebugWindow("need to eat food buttonToPress:" + buttonToPress,0,1,2000,0)		
	}

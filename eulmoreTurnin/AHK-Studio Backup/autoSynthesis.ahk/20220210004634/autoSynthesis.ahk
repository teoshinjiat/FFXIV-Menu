...
runMacro(durability){
	...
	ifequal durability,"40", ControlSend, , {Numpad1}, ahk_class FFXIVGAME
	ifequal durability,"70", ControlSend, , {Numpad1}, ahk_class FFXIVGAME
	ifequal durability,"80", ControlSend, , {Numpad1}, ahk_class FFXIVGAME
}

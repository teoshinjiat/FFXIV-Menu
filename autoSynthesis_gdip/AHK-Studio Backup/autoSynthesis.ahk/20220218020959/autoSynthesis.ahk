...
preHealthCheck(){
	...
	DebugWindow("FoodFlag:" eatFoodFlag,0,1,2000,0)
	
	if(eatFoodFlag=1){
		DebugWindow(" inside if FoodFlag:" eatFoodFlag, 0,1,2000,0)
	...
	DebugWindow("MedicineFlag:" eatMedicineFlag,0,1,2000,0)
	
	if(eatMedicineFlag=1){
		DebugWindow("inside MedicineFlag:" eatMedicineFlag,0,1,2000,0)

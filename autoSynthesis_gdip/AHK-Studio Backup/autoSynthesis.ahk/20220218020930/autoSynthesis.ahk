...
preHealthCheck(){
	...
	DebugWindow("vFoodFlag:" eatFoodFlag,0,1,2000,0)
	
	if(eatFoodFlag=1){
		DebugWindow(" inside if vFoodFlag:" eatFoodFlag, 0,1,2000,0)
	...
	DebugWindow("vMedicineFlag:" eatMedicineFlag,0,1,2000,0)
	
	if(eatMedicineFlag=1){
		DebugWindow("inside vMedicineFlag:" eatMedicineFlag,0,1,2000,0)

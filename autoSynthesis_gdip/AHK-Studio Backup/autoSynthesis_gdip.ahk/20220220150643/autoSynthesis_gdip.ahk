...
processWindowImage(){
	...
	if !qpBitmap := Gdip_BitmapFromHWND(gameId)
	{
		log("Gdip_BitmapFromHWND fail")
		ExitApp
	}
	
	if Gdip_SaveBitmapToFile(qpBitmap, img := A_ScriptDir "\screen.png")
	{
		log("Gdip_SaveBitmapToFile fail11")
		ExitApp
	}
	Gdip_DisposeImage(qpBitmap) ; clearing for reassignation

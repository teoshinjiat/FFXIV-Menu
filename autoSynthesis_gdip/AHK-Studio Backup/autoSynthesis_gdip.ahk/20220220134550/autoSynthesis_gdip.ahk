...
DebugWindow("Started Auto Synthesis GDIP",1,1,200,0)

haystack=%A_ScriptDir%\gdip.png
bmpHaystack := Gdip_CreateBitmapFromFile(haystack)
;Run % A_ScriptDir "\gdip.png"
needle=%A_ScriptDir%\food.png
